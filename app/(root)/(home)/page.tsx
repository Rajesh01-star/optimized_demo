...
import { getResources, getResourcesPlaylist } from '@/sanity/actions/actions'
...
const Page = async ({ searchParams }: Props) => {
  ...
  return (
    <main className='flex-center paddings mx-auto w-full max-w-screen-xl flex-col'>
      ...
      <Filters />
      {/* Resources to show when searched */}
